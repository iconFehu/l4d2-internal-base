...
void Manager::Init()
{
	featurelist.push_back(F::BHop::Getinstance());
	featurelist.push_back(F::ArraylistModule::Getinstance());
	featurelist.push_back(F::AimbotModule::Getinstance());
	featurelist.push_back(F::NoSpreadModule::Getinstance());
	featurelist.push_back(F::AimAssistModule::Getinstance());
	featurelist.push_back(F::ESPHelperModule::Getinstance());
}
